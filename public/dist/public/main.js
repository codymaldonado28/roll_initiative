...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngIf='characterClass'>\r\n    <h1>Class: {{characterClass.name}}</h1>\r\n    <div>\r\n        <h4>Hit-Die: {{characterClass['hit_die']}}</h4>\r\n        <h4>Saving-Throws</h4>\r\n        <div>\r\n            <ul *ngFor=\"let throw of characterClass['saving_throws']\">\r\n                <li>{{throw.name}}</li>\r\n            </ul>\r\n        </div>\r\n        <div *ngIf='classFeatures.length>0'>\r\n            <h4>Class Features:</h4>\r\n            <ul *ngFor='let f of classFeatures'>\r\n                <li>{{f.name}}</li>\r\n            </ul>\r\n        </div>\r\n        <div>\r\n            <h4>Class Proficiencies</h4>\r\n            <ul *ngFor=\" let pros of characterClass['proficiencies']\">\r\n                <li>{{pros.name}}</li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n    <h2>Choose Your Attributes</h2>\r\n    <h3>Choose {{characterClass['proficiency_choices'][0]['choose']}} Skills:</h3>\r\n    <div style='vertical-align: top; display: inline-block' *ngFor=\"let skill of  classSkills\">\r\n        <button style='margin:3px' *ngIf='skill.added==false' (click)='addSkill(skill)'>{{skill.name}}</button>\r\n        <button style='background-color: red; margin:3px; color:white' *ngIf='skill.added==true'\r\n            (click)='cancelSkill(skill)'>{{skill.name}}</button>\r\n    </div>\r\n</div>\r\n<div *ngIf='classSpells'>\r\n    <div *ngFor=\"let level of classSpells; let i = index\" [attr.data-index]='i'>\r\n        <div *ngIf=\"level.length>0\">\r\n            <h3>Pick {{spellLimit}} Spells from level {{i}} spells</h3>\r\n            <div style='vertical-align: top; display: inline-block' *ngFor='let spell of level'>\r\n                <button style='margin:3px' *ngIf='spell.added==false'\r\n                    (click)='addSpell(spell, i)'>{{spell.name}}</button>\r\n                <button style='margin:3px; background-color: red; color: white' *ngIf='spell.added==true'\r\n                    (click)='cancelSpell(spell, i)'>{{spell.name}}</button>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</div>\r\n<div>\r\n    <h4>Choose Stats:</h4>\r\n    <div>\r\n        <span *ngIf='stats.strength == null'>Strength: </span>\r\n        <span *ngIf='stats.strength != null' style=\"color: red; text-decoration: underline;\">Strength: is\r\n            {{stats.strength}}</span>\r\n\r\n        <button *ngIf='stats.strength!=8' style='margin:10px;' (click)='addStat(\"strength\", 8 )'>8</button>\r\n        <button *ngIf='stats.strength == 8' style='background-color: red; color:white;'\r\n            (click)='addStat(\"strength\", 8)'>8</button>\r\n\r\n        <button *ngIf='stats.strength!=10' style='margin:10px;' (click)='addStat(\"strength\", 10 )'>10</button>\r\n        <button *ngIf='stats.strength == 10' style='background-color: red; color:white;'\r\n            (click)='addStat(\"strength\", 10)'>10</button>\r\n\r\n        <button *ngIf='stats.strength!=12' style='margin:10px;' (click)='addStat(\"strength\", 12 )'>12</button>\r\n        <button *ngIf='stats.strength == 12' style='background-color: red; color:white;'\r\n            (click)='addStat(\"strength\", 12)'>12</button>\r\n\r\n        <button *ngIf='stats.strength!=13' style='margin:10px;' (click)='addStat(\"strength\", 13 )'>13</button>\r\n        <button *ngIf='stats.strength == 13' style='background-color: red; color:white;'\r\n            (click)='addStat(\"strength\", 13)'>13</button>\r\n\r\n        <button *ngIf='stats.strength!=14' style='margin:10px;' (click)='addStat(\"strength\", 14 )'>14</button>\r\n        <button *ngIf='stats.strength == 14' style='background-color: red; color:white;'\r\n            (click)='addStat(\"strength\", 14)'>14</button>\r\n\r\n        <button *ngIf='stats.strength!=15' style='margin:10px;' (click)='addStat(\"strength\", 15 )'>15</button>\r\n        <button *ngIf='stats.strength == 15' style='background-color: red; color:white;'\r\n            (click)='addStat(\"strength\", 15)'>15</button>\r\n    </div>\r\n    <div>\r\n        <span *ngIf='stats.dexterity == null'>Dexterity: </span>\r\n        <span *ngIf='stats.dexterity != null' style=\"color: red; text-decoration: underline;\">Dexterity: is\r\n            {{stats.dexterity}}</span>\r\n\r\n        <button *ngIf='stats.dexterity!=8' style='margin:10px;' (click)='addStat(\"dexterity\", 8 )'>8</button>\r\n        <button *ngIf='stats.dexterity == 8' style='background-color: red; color:white;'\r\n            (click)='addStat(\"dexterity\", 8)'>8</button>\r\n\r\n        <button *ngIf='stats.dexterity!=10' style='margin:10px;' (click)='addStat(\"dexterity\", 10 )'>10</button>\r\n        <button *ngIf='stats.dexterity == 10' style='background-color: red; color:white;'\r\n            (click)='addStat(\"dexterity\", 10)'>10</button>\r\n\r\n        <button *ngIf='stats.dexterity!=12' style='margin:10px;' (click)='addStat(\"dexterity\", 12 )'>12</button>\r\n        <button *ngIf='stats.dexterity == 12' style='background-color: red; color:white;'\r\n            (click)='addStat(\"dexterity\", 12)'>12</button>\r\n\r\n        <button *ngIf='stats.dexterity!=13' style='margin:10px;' (click)='addStat(\"dexterity\", 13 )'>13</button>\r\n        <button *ngIf='stats.dexterity == 13' style='background-color: red; color:white;'\r\n            (click)='addStat(\"dexterity\", 13)'>13</button>\r\n\r\n        <button *ngIf='stats.dexterity!=14' style='margin:10px;' (click)='addStat(\"dexterity\", 14 )'>14</button>\r\n        <button *ngIf='stats.dexterity == 14' style='background-color: red; color:white;'\r\n            (click)='addStat(\"dexterity\", 14)'>14</button>\r\n\r\n        <button *ngIf='stats.dexterity!=15' style='margin:10px;' (click)='addStat(\"dexterity\", 15 )'>15</button>\r\n        <button *ngIf='stats.dexterity == 15' style='background-color: red; color:white;'\r\n            (click)='addStat(\"dexterity\", 15)'>15</button>\r\n\r\n\r\n    </div>\r\n    <div>\r\n        <span *ngIf='stats.constitution == null'>Constitution: </span>\r\n        <span *ngIf='stats.constitution != null' style=\"color: red; text-decoration: underline;\">Constitution: is\r\n            {{stats.constitution}}</span>\r\n\r\n        <button *ngIf='stats.constitution!=8' style='margin:10px;' (click)='addStat(\"constitution\", 8 )'>8</button>\r\n        <button *ngIf='stats.constitution == 8' style='background-color: red; color:white;'\r\n            (click)='addStat(\"constitution\", 8)'>8</button>\r\n\r\n        <button *ngIf='stats.constitution!=10' style='margin:10px;' (click)='addStat(\"constitution\", 10 )'>10</button>\r\n        <button *ngIf='stats.constitution == 10' style='background-color: red; color:white;'\r\n            (click)='addStat(\"constitution\", 10)'>10</button>\r\n\r\n        <button *ngIf='stats.constitution!=12' style='margin:10px;' (click)='addStat(\"constitution\", 12 )'>12</button>\r\n        <button *ngIf='stats.constitution == 12' style='background-color: red; color:white;'\r\n            (click)='addStat(\"constitution\", 12)'>12</button>\r\n\r\n        <button *ngIf='stats.constitution!=13' style='margin:10px;' (click)='addStat(\"constitution\", 13 )'>13</button>\r\n        <button *ngIf='stats.constitution == 13' style='background-color: red; color:white;'\r\n            (click)='addStat(\"constitution\", 13)'>13</button>\r\n\r\n        <button *ngIf='stats.constitution!=14' style='margin:10px;' (click)='addStat(\"constitution\", 14 )'>14</button>\r\n        <button *ngIf='stats.constitution == 14' style='background-color: red; color:white;'\r\n            (click)='addStat(\"constitution\", 14)'>14</button>\r\n\r\n        <button *ngIf='stats.constitution!=15' style='margin:10px;' (click)='addStat(\"constitution\", 15 )'>15</button>\r\n        <button *ngIf='stats.constitution == 15' style='background-color: red; color:white;'\r\n            (click)='addStat(\"constitution\", 15)'>15</button>\r\n\r\n    </div>\r\n    <div>\r\n        <span *ngIf='stats.intelligence == null'>Intelligence: </span>\r\n        <span *ngIf='stats.intelligence != null' style=\"color: red; text-decoration: underline;\">Intelligence: is\r\n            {{stats.intelligence}}</span>\r\n\r\n        <button *ngIf='stats.intelligence!=8' style='margin:10px;' (click)='addStat(\"intelligence\", 8 )'>8</button>\r\n        <button *ngIf='stats.intelligence == 8' style='background-color: red; color:white;'\r\n            (click)='addStat(\"intelligence\", 8)'>8</button>\r\n\r\n        <button *ngIf='stats.intelligence!=10' style='margin:10px;' (click)='addStat(\"intelligence\", 10 )'>10</button>\r\n        <button *ngIf='stats.intelligence == 10' style='background-color: red; color:white;'\r\n            (click)='addStat(\"intelligence\", 10)'>10</button>\r\n\r\n        <button *ngIf='stats.intelligence!=12' style='margin:10px;' (click)='addStat(\"intelligence\", 12 )'>12</button>\r\n        <button *ngIf='stats.intelligence == 12' style='background-color: red; color:white;'\r\n            (click)='addStat(\"intelligence\", 12)'>12</button>\r\n\r\n        <button *ngIf='stats.intelligence!=13' style='margin:10px;' (click)='addStat(\"intelligence\", 13 )'>13</button>\r\n        <button *ngIf='stats.intelligence == 13' style='background-color: red; color:white;'\r\n            (click)='addStat(\"intelligence\", 13)'>13</button>\r\n\r\n        <button *ngIf='stats.intelligence!=14' style='margin:10px;' (click)='addStat(\"intelligence\", 14 )'>14</button>\r\n        <button *ngIf='stats.intelligence == 14' style='background-color: red; color:white;'\r\n            (click)='addStat(\"intelligence\", 14)'>14</button>\r\n\r\n        <button *ngIf='stats.intelligence!=15' style='margin:10px;' (click)='addStat(\"intelligence\", 15 )'>15</button>\r\n        <button *ngIf='stats.intelligence == 15' style='background-color: red; color:white;'\r\n            (click)='addStat(\"intelligence\", 15)'>15</button>\r\n\r\n    </div>\r\n    <div>\r\n        <span *ngIf='stats.wisdom == null'>Wisdom: </span>\r\n        <span *ngIf='stats.wisdom != null' style=\"color: red; text-decoration: underline;\">Wisdom: is\r\n            {{stats.wisdom}}</span>\r\n\r\n        <button *ngIf='stats.wisdom!=8' style='margin:10px;' (click)='addStat(\"wisdom\", 8 )'>8</button>\r\n        <button *ngIf='stats.wisdom == 8' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"wisdom\", 8)'>8</button>\r\n\r\n        <button *ngIf='stats.wisdom!=10' style='margin:10px;' (click)='addStat(\"wisdom\", 10 )'>10</button>\r\n        <button *ngIf='stats.wisdom == 10' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"wisdom\", 10)'>10</button>\r\n\r\n        <button *ngIf='stats.wisdom!=12' style='margin:10px;' (click)='addStat(\"wisdom\", 12 )'>12</button>\r\n        <button *ngIf='stats.wisdom == 12' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"wisdom\", 12)'>12</button>\r\n\r\n        <button *ngIf='stats.wisdom!=13' style='margin:10px;' (click)='addStat(\"wisdom\", 13 )'>13</button>\r\n        <button *ngIf='stats.wisdom == 13' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"wisdom\", 13)'>13</button>\r\n\r\n        <button *ngIf='stats.wisdom!=14' style='margin:10px;' (click)='addStat(\"wisdom\", 14 )'>14</button>\r\n        <button *ngIf='stats.wisdom == 14' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"wisdom\", 14)'>14</button>\r\n\r\n        <button *ngIf='stats.wisdom!=15' style='margin:10px;' (click)='addStat(\"wisdom\", 15 )'>15</button>\r\n        <button *ngIf='stats.wisdom == 15' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"wisdom\", 15)'>15</button>\r\n    </div>\r\n    <div>\r\n        <span *ngIf='stats.charisma == null'>Charisma: </span>\r\n        <span *ngIf='stats.charisma != null' style=\"color: red; text-decoration: underline;\">Charisma: is\r\n            {{stats.charisma}}</span>\r\n\r\n        <button *ngIf='stats.charisma!=8' style='margin:10px;' (click)='addStat(\"charisma\", 8 )'>8</button>\r\n        <button *ngIf='stats.charisma == 8' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"charisma\", 8)'>8</button>\r\n\r\n        <button *ngIf='stats.charisma!=10' style='margin:10px;' (click)='addStat(\"charisma\", 10 )'>10</button>\r\n        <button *ngIf='stats.charisma == 10' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"charisma\", 10)'>10</button>\r\n\r\n        <button *ngIf='stats.charisma!=12' style='margin:10px;' (click)='addStat(\"charisma\", 12 )'>12</button>\r\n        <button *ngIf='stats.charisma == 12' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"charisma\", 12)'>12</button>\r\n\r\n        <button *ngIf='stats.charisma!=13' style='margin:10px;' (click)='addStat(\"charisma\", 13 )'>13</button>\r\n        <button *ngIf='stats.charisma == 13' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"charisma\", 13)'>13</button>\r\n\r\n        <button *ngIf='stats.charisma!=14' style='margin:10px;' (click)='addStat(\"charisma\", 14 )'>14</button>\r\n        <button *ngIf='stats.charisma == 14' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"charisma\", 14)'>14</button>\r\n\r\n        <button *ngIf='stats.charisma!=15' (click)='addStat(\"charisma\", 15 )'>15</button>\r\n        <button *ngIf='stats.charisma == 15' style='background-color: red; color:white; margin:10px;'\r\n            (click)='addStat(\"charisma\", 15)'>15</button>\r\n    </div>\r\n</div>\r\n<div *ngIf='errors'>\r\n    <div *ngFor='let err of errors'>\r\n        <p style='color:red; font-size: large;'>{{err}}</p>\r\n    </div>\r\n</div>\r\n<button\r\n    style='background-image: linear-gradient(rgb(235, 222, 153),gold,gold, rgb(235, 222, 153)); box-shadow: 5px 5px rgb(41, 36, 9); color: white; width:300px; height: 100px;margin-top:20px; margin-left: 30%; border-radius: 5px; '\r\n    (click)='createCharacter()'>Create Character</button>");
